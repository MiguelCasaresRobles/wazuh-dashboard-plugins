...
export interface Digest {
   ...
   *
   * Omitted for a real aggregation whose buckets are complete and within the carry budget (its
   * COUNTS are always population-true: OpenSearch computes `aggregations` over every matched doc
