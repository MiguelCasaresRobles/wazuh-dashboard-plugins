...
test('get_agent_inventory: kind="ports" matches get_agent_ports\'s original body with _source reordered, plus the new interface.state/network.transport breakdown aggs', () => {
